...
module Analytics
  ...
  module AnalyticsProcess
    ...
    def print_disciplines_info(id:)
      Queries::SemestersQuery.new.discipline_ids_by_id(id: id).each do |discipline_id|
        print 'Discipline: '
    ...
    def all_discipline_grades(id:)
      all_grades = []
      Queries::SemestersQuery.new.discipline_ids_by_id(id: id).each do |_discipline_id|
        all_grades << Queries::DisciplinesQuery.grades_by_id(id: id).map(&:to_i)
      end
